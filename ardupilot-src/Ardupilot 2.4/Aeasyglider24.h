/********************************************/
/* ArduPilot Header file for Easyglider     */
/* Ardupilot v2.4.3, good luck!             */
/* Tested in flight on Nov 8, 2009          */
/********************************************/
// 11-04-09 : JLN Added A-1 GPS_PROTOCOL 3 for GPS Emulator
...
// Airframe settings
//1-1
#define ALT_HOLD_HOME 1 //What altitude you want to hold for home, 0 = the one you are when you switch to RTL, 1 = the altitude defined by the configuration tool.
//1-2
...
//1-7
#define GPS_PROTOCOL 1 // 0 = NMEA, 1=SIRF, 2=uBlox, 3=GPSEmulator : Choose protocol
//1-8
...
//2-3
#define FLY_BY_WIRE_SPEED_SETPOINT 35 //The airspeed you want to hold in fly by wire mode.
//2-4
...
//6-7
#define PITCH_COMP .25 //<------Very important, Pitch compensation vs. Roll bank angle. 
...
//7-4
#define throttle_absolute 5 //Absolute
//7-5
...
//8-1
#define ALTITUDE_ERROR_MAX 2 //  10
//8-2
#define ALTITUDE_ERROR_MIN -10 //
//8-3
#define ALTITUDE_ERROR_PITCH_PROPORTIONAL 1.5 //Altitude error proportional, pitch setpoint
//8-4
#define ALTITUDE_ERROR_PITCH_MAX 1 // 15 Altitud Hold aircraft pitch limits in degrees, if you add to much you may stall... 
//8-5
#define ALTITUDE_ERROR_PITCH_MIN -14  // -15
//8-6
#define AIRSPEED_CENTRAL 40 // 30 Airspeed  central point in m/s, normal flight... This value is the lowest airspeed that makes your plane flight steady. 
//8-7
#define ALTITUDE_ERROR_AIRSPEED_PROPORTIONAL 3  // 3
//8-8
#define ALTITUDE_ERROR_AIRSPEED_MAX 10  // 30
//8-9
